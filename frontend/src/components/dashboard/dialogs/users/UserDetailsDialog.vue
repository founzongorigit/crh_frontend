...
const photoProfileUrl = computed(() => getBackendFileUrl(props.user?.photo_profile))
...
<template>
  <Dialog v-model:visible="visible" header="Détail de l'utilisateur" modal class="user-dialog" dismissable-mask>
    <div v-if="user" class="user-details">
      ...
      <div>
       ...
       <div>
        ...
        <a v-if="photoProfileUrl" :href="photoProfileUrl" target="_blank" rel="noreferrer">Voir la photo</a>
    ...
    <template #footer>
      ...
      <Button v-if="editable" label="Modifier" icon="pi pi-pencil" @click="editUser" />
    </template>
  </Dialog>
</template>
