...
import type { AffectationConseillerLocalite } from '@/types/affectation'
...
<template>
  <Dialog v-model:visible="visible" header="Détail de l'affectation" modal class="affectation-dialog" dismissable-mask>
    <div v-if="firstAffectation" class="affectation-details">
      <div>
        <span class="detail-label">Conseiller</span>
        <strong>{{ firstAffectation.conseiller_nom }}</strong>
      </div>
      <div>
        <span class="detail-label">Email</span>
        <strong>{{ firstAffectation.conseiller_email }}</strong>
      </div>
      ...
      <div class="details-wide affectation-list">
        ...
        >
          <strong>{{ affectation.localite_nom }}</strong>
          <Tag
