...
<template>
  <Dialog v-model:visible="visible" header="Détail du paiement" modal class="paiement-dialog">
    <div v-if="paiement" class="paiement-details">
      ...
      <div class="details-wide">
        ...
        <a v-if="paiement.justificatif" :href="paiement.justificatif" target="_blank" rel="noreferrer">
